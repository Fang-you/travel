...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/后端-微信云开发-07C160" alt="微信云开发"/>
...
- 在微信开发者工具中点击「云开发」按钮
- 创建云开发环境
- 将环境 ID 填入 `miniprogram/app.js` 中的 `env` 字段
...
- 导入 `database/trip_database.sql` 到你的 MySQL 数据库
- 或使用微信云数据库（需修改数据访问逻辑）
